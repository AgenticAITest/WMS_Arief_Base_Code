...
export const EditAdjustmentModal: React.FC<EditAdjustmentModalProps> = ({
  ...
  const loadAdjustmentDetails = async () => {
    try {
      ...
      const adjustment = adjResponse.data.data;
      ...
      toast.error(error.response?.data?.message || 'Failed to load adjustment details');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.put(`/api/modules/inventory-items/adjustments/${adjustmentId}`, payload);
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 border rounded-lg p-4">
              <h3 className="text-sm font-semibold">Add Items by SKU</h3>
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        SKU: {skuSearchResults.product.sku}
                      </div>
                    </div>
                    <Button
                      type="button"
                      ...
                      {adjustmentItems.map((item) => {
                        ...
                        return (
                          <TableRow key={item.inventoryItemId}>
                            ...
                            <TableCell className="text-sm text-muted-foreground">{item.binName}</TableCell>
