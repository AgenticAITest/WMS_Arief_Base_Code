...
- **Oct 29, 2025**:
  - **Confirm Putaway Authorization Fix**: Fixed 401 unauthorized error in confirm putaway endpoint. Changed `req.user?.tenantId` to `req.user?.activeTenantId` to match the authentication middleware's user object structure.
- **Oct 28, 2025**:
